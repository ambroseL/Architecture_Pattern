...
bool Welcomelayer::init()
{
	...
	auto startItem = MenuItemImage::create
		(
			...
			CC_CALLBACK_1(Welcomelayer::menuStart, this) //点击时执行的回调方法
		);
	//设置开始菜单项的位置
	...
	auto helpItem = MenuItemImage::create
		(
			...
			CC_CALLBACK_1(Welcomelayer::menuHelp, this) //点击时执行的回调方法
		);
	...
	auto exitItem = MenuItemImage::create
		(
			"Image/exit1.png",
			"Image/exit2.png",
			CC_CALLBACK_1(Welcomelayer::menuExit, this) //点击时执行的回调方法
		);
